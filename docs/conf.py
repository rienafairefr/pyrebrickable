# -*- coding: utf-8 -*-
#
# pyrebrickable documentation build configuration file, created by
...
# ones.
extensions = ['sphinx_click.ext', 'sphinx.ext.githubpages', 'sphinx.ext.autodoc']
...
htmlhelp_basename = 'pyrebrickabledoc'
...
latex_documents = [
    (master_doc, 'pyrebrickable.tex', u'pyrebrickable Documentation',
...
man_pages = [
    (master_doc, 'pyrebrickable', u'pyrebrickable Documentation',
     [author], 1)
]
